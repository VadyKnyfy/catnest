  ...
  <body>
    ...
    <div id="content">
     ...
     <!--Новинки-->
      ...
      <div id="event-panel">
        <swiper-container class="eventSwiper" pagination="true" pagination-clickable="true" navigation="true" space-between="30" loop="true" autoplay-delay="3000" autoplay-disable-on-interaction="false">
