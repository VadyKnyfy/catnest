...
for (let value of Object.keys(cartO)) {
  ...
  function showorderItem(itemid){
      ...
      var str = '<div class="order_item">' +
              '<div id="order_item_image"><a href="../pages/book.php?id='+itemid+'"><img src="../image/books/b'+itemid+'.jpg"></a></div>'+
              '<a id="order_item_name" href="../pages/book.php?id='+itemid+'"><label>'+cartitemall[itemid][0]+'</label></a>'+
              '<div id="order_item_amount"><label id="order_item_h1">Кількість</label><label>'+cartO[itemid]+'</label></div>'+
              '<div id="order_item_price"><label id="order_item_h1">Сума</label><label>'+ price +'</label></div></div>'
            return str;
}
